...
function ShoppingBag() {
    ...
    this.averagePrice = function () {
        ...
        return (averagePricee / this.productsList.length).toFixed(3);
    }
...
var checkoutAndBuy=function(bag, card){
    ...
    if(cardBalance>bagPrice){
        ...
        return ((bagPrice-cardBalance).toFixed(2)+ "$ is missing to complete the purchase!");
    }
}
...
var product1 = createProduct("Banana", 129.99, "07.26.2020");
var product2 = createProduct("Jagoda", 249.99, "07.26.2020");
var product3 = createProduct("Mandarina", 159.99,"07.26.2020");

var bag = createShoppingBag();

var card= createPaymentCard(150, "active", "06/01/2020");

bag.addProduct(product1);
bag.addProduct(product2);
bag.addProduct(product3);

var checkout=checkoutAndBuy(bag, card);
